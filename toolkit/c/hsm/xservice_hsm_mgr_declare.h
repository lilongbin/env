...
HSM_BEGIN(XSERVICE_MGR_HSM)\
  ...
  HSM_COMPOSITE_STATE(STATE_READING, HSM_TOP, HSM_NO_INITIAL_STATE, STATE_SHALLOW_HIST, HSM_NO_ACTION, HSM_NO_ACTION)\
    HSM_COMPOSITE_COMPLETION_TRANSITION(STATE_READING, HSM_NO_ACTION, STATE_DEEP_HIST)\
    HSM_EXTERNAL_TRANSITION(EVT_TypedKeyPound, HSM_NO_GUARD, STATE_READING, onInterupt2, STATE_DEEP_HIST)\
  ...
  HSM_COMPOSITE_STATE(STATE_WORKING, HSM_TOP, HSM_NO_INITIAL_STATE, STATE_DEEP_HIST, HSM_NO_ACTION, HSM_NO_ACTION)\
    HSM_EXTERNAL_TRANSITION(EVT_TypedKeyPound, HSM_NO_GUARD, STATE_WORKING, onInterupt1, STATE_SHALLOW_HIST)\
  ...
  HSM_JUNCTION_STATE(STATE_OPEN, STATE_READING)\
    HSM_EXTERNAL_TRANSITION(HSM_NO_EVENT, HSM_NO_GUARD, STATE_OPEN, proc_open, STATE_PAGEX)\
  HSM_END_STATE(STATE_OPEN)\
  /*=================== STATE: STATE_PAGEX ===============================*/\
  HSM_SIMPLE_STATE(STATE_PAGEX, STATE_READING, HSM_NO_ACTION, HSM_NO_ACTION)\
    HSM_EXTERNAL_TRANSITION(EVT_TypedKeyEnter, HSM_NO_GUARD, STATE_PAGEX, proc_close, STATE_CLOSE)\
  ...
  HSM_JUNCTION_STATE(STATE_RESTART, STATE_WORKING)\
    HSM_EXTERNAL_TRANSITION(HSM_NO_EVENT, HSM_NO_GUARD, STATE_RESTART, prompt_reset, STATE_EMPTY)\
  ...
  HSM_COMPOSITE_STATE(STATE_TYPING, STATE_WORKING, HSM_NO_INITIAL_STATE, HSM_NO_HISTORY_STATE, HSM_NO_ACTION, HSM_NO_ACTION)\
    HSM_EXTERNAL_TRANSITION(EVT_TypedKeyEnter, HSM_NO_GUARD, STATE_TYPING, resulted, STATE_RESTART)\
  ...
  HSM_SIMPLE_STATE(STATE_EMPTY, STATE_WORKING, HSM_NO_ACTION, HSM_NO_ACTION)\
    HSM_EXTERNAL_TRANSITION(EVT_TypedKeyNumber0, HSM_NO_GUARD, STATE_EMPTY, proc_lead0, STATE_LEAD0)\
    HSM_EXTERNAL_TRANSITION(EVT_TypedKeyNumber1_9, HSM_NO_GUARD, STATE_EMPTY, proc_int, STATE_INTEGER)\
    HSM_EXTERNAL_TRANSITION(EVT_TypedKeySign, HSM_NO_GUARD, STATE_EMPTY, proc_signed, STATE_SIGNED)\
    HSM_INTERNAL_TRANSITION(EVT_TypedKeyDot, HSM_NO_GUARD, onError)\
  ...
  HSM_SIMPLE_STATE(STATE_INTEGER, STATE_TYPING, HSM_NO_ACTION, HSM_NO_ACTION)\
    HSM_EXTERNAL_TRANSITION(EVT_TypedKeyDot, HSM_NO_GUARD, STATE_INTEGER, proc_dot, STATE_DECIMAL)\
  ...
  HSM_SIMPLE_STATE(STATE_LEAD0, STATE_TYPING, HSM_NO_ACTION, HSM_NO_ACTION)\
    HSM_EXTERNAL_TRANSITION(EVT_TypedKeyDot, HSM_NO_GUARD, STATE_LEAD0, proc_dot, STATE_DECIMAL)\
  ...
  HSM_SIMPLE_STATE(STATE_SIGNED, STATE_TYPING, HSM_NO_ACTION, HSM_NO_ACTION)\
    HSM_EXTERNAL_TRANSITION(EVT_TypedKeyNumber0, HSM_NO_GUARD, STATE_SIGNED, proc_lead0, STATE_LEAD0)\
    HSM_EXTERNAL_TRANSITION(EVT_TypedKeyNumber1_9, HSM_NO_GUARD, STATE_SIGNED, proc_int, STATE_INTEGER)\
