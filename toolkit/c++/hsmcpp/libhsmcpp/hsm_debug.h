...
private:
    ...
    HSM_EventNameFunc_T m_get_event_name_func; //std::string getEventName(HSM_Event_T event);
    int m_log_level;
...
public:
    ...
    HSM_Debug(std::string tag, HSM_DbgFunc_T debug_func, HSM_EventNameFunc_T eventfunc, int level, HSM_LogFunc_T logfunc) {
        ...
        m_get_event_name_func = eventfunc;
        m_log_level = level;
        m_log_func = logfunc;
    }
    ~HSM_Debug() {}
    ...
    HSM_EventNameFunc_T event_name_func() {
        return m_get_event_name_func;
    }
    int log_level() {
        return m_log_level;
    }
