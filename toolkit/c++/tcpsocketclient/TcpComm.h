...
#define TCP_MSG_MAX_LEN 0x7FFF
#define TCP_MSG_HEADER_LEN 16
...
//#define GetTcpDataLength(buff, offset) (NH_SWAP32(buff[offset]))
#define GetTcpDataLength(buff, offset) ((*(uint32_t *)(buff+offset)))
