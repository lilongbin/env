...
TOOLS_EMBED="uml-utilities squashfs-tools libelf-dev libelf-devel elfutils-libelf-devel qemu ninja-build meson arduino "
TOOLS_CODING="meld dos2unix unix2dos tofrodos subversion git-core gitk "
TOOLS_DESIGN="dia umbrello plantuml "
TOOLS_BUILD="build-essential libtool cmake automake flex bison gperf graphviz gnupg gettext mingw32 readline readline-devel libc6-dev libc++-dev lib32stdc++6 lib32bz2-1.0 lib32bz2-dev gcc gcc-c++ g++ g++-multilib zlib zlib-devel tshark libncurses5-dev libncursesw5-dev libjsoncpp-dev ccache libmagickwand-dev liblz4-tool "
