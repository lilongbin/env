...
let g:txtbrowser_version = "1.3.5"
...
if !exists('TxtBrowser_Dict_Url')
    ...
    let TxtBrowser_Dict_Url = 'http://www.baidu.com/s?wd=text&oq=text&f=3&rsp=2i'
endif
...
"===================================================================
"Default map:
" commented by longbin on 2014-12-05 to prevent the conflict with cscope's
" keyboard shortcuts;
